...
public class Manufacturer extends TableImpl<ManufacturerRecord> {
     ...
     */
    public final TableField<ManufacturerRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("gen_random_uuid()", SQLDataType.UUID)), this, "");

    /**
     * The column <code>public.manufacturer.name</code>.
     */
    public final TableField<ManufacturerRecord, String> NAME = createField(DSL.name("name"), SQLDataType.CLOB.nullable(false), this, "");
