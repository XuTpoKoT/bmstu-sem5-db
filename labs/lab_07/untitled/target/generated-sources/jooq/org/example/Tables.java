...
public class Tables {
     ...
     */
    public static final CategoryView CATEGORY_VIEW = CategoryView.CATEGORY_VIEW;
     ...
     */
    public static final CustomerView CUSTOMER_VIEW = CustomerView.CUSTOMER_VIEW;

    /**
     * The table <code>public.customers_json</code>.
     */
    public static final CustomersJson CUSTOMERS_JSON = CustomersJson.CUSTOMERS_JSON;
     ...
     */
    public static final Fib FIB = Fib.FIB;
     ...
     */
    public static final GetCustomer GET_CUSTOMER = GetCustomer.GET_CUSTOMER;
     ...
     */
    public static final GetCustomerByFullname GET_CUSTOMER_BY_FULLNAME = GetCustomerByFullname.GET_CUSTOMER_BY_FULLNAME;
     ...
     */
    public static final GetCustomerByNames GET_CUSTOMER_BY_NAMES = GetCustomerByNames.GET_CUSTOMER_BY_NAMES;
     ...
     */
    public static final GetProductModelsByColor GET_PRODUCT_MODELS_BY_COLOR = GetProductModelsByColor.GET_PRODUCT_MODELS_BY_COLOR;
     ...
     */
    public static final Guitarmodeltype GUITARMODELTYPE = Guitarmodeltype.GUITARMODELTYPE;
     ...
     */
    public static final Material MATERIAL = Material.MATERIAL;

    /**
     * The table <code>public.order_productmodel</code>.
     */
    public static final OrderProductmodel ORDER_PRODUCTMODEL = OrderProductmodel.ORDER_PRODUCTMODEL;
     ...
     */
    public static final OrdersJson ORDERS_JSON = OrdersJson.ORDERS_JSON;
     ...
     */
    public static final Productmodel PRODUCTMODEL = Productmodel.PRODUCTMODEL;

    /**
     * The table <code>public.soundpickup</code>.
     */
    public static final Soundpickup SOUNDPICKUP = Soundpickup.SOUNDPICKUP;

    /**
     * The table <code>public.table2json</code>.
     */
    public static final Table2json TABLE2JSON = Table2json.TABLE2JSON;
     ...
     */
    public static final ZeroOrdersView ZERO_ORDERS_VIEW = ZeroOrdersView.ZERO_ORDERS_VIEW;
}
